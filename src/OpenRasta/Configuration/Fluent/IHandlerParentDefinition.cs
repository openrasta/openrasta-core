...
namespace OpenRasta.Configuration.Fluent
{
    ...
    public static class FluentExtensionExtensions
    {
        ...
        public static IUriDefinition AtUri(this IResource resource, string uri)
        {
            ...
            if (hackedBaseType == null) throw new InvalidOperationException("Something has gone wonky in the compat API. <sigh>");

            return hackedBaseType.AtUri(uri);
        }
        //public static IUriDefinition<TResource> AtUri<TResource>(this IResource<TResource> resource, string uri)
        //{
        //    if (uri == null) throw new ArgumentNullException("uri");

        //    var hackedBaseType = resource as IResourceDefinition<TResource>;
